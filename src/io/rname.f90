...
integer :: ii,nv
integer :: inrflg
integer, parameter ::nvgrid=37,nvstrt=78,nvindat=202,nvsound=10
...
DATA INDAT/  &
     ...
     ,'RIMEFACH','SHEDFAC','RAINMINEFF'									&
	 ,'CLOUD_CFMAS_FAC','RAIN_CFMAS_FAC','PRIS_CFMAS_FAC','SNOW_CFMAS_FAC' &
	 ,'AGG_CFMAS_FAC','GRAUP_CFMAS_FAC','HAIL_CFMAS_FAC','DRIZ_CFMAS_FAC' &
	 ,'CLOUD_PWMAS_FAC','RAIN_PWMAS_FAC','PRIS_PWMAS_FAC','SNOW_PWMAS_FAC' &
	 ,'AGG_PWMAS_FAC','GRAUP_PWMAS_FAC','HAIL_PWMAS_FAC','DRIZ_PWMAS_FAC' &
	 ,'CLOUD_CFVT_FAC','RAIN_CFVT_FAC','PRIS_CFVT_FAC','SNOW_CFVT_FAC' &
	 ,'AGG_CFVT_FAC','GRAUP_CFVT_FAC','HAIL_CFVT_FAC','DRIZ_CFVT_FAC' &
	 ,'CLOUD_PWVT_FAC','RAIN_PWVT_FAC','PRIS_PWVT_FAC','SNOW_PWVT_FAC' &
	 ,'AGG_PWVT_FAC','GRAUP_PWVT_FAC','HAIL_PWVT_FAC','DRIZ_PWVT_FAC'/
...
IF(GROUP.EQ.'$MODEL_OPTIONS') THEN
 ...
 IF(VR.EQ.'RIMEFACS')    CALL varsetf (VR,RIMEFACS,NV,1,FF,0.,5.)
 ...
 IF(VR.EQ.'RAINMINEFF') CALL varsetf (VR,RAINMINEFF,NV,1,FF,-10.,10.)
 IF(VR.EQ.'CLOUD_CFMAS_FAC')    CALL varsetf (VR,CLOUD_CFMAS_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'RAIN_CFMAS_FAC')    CALL varsetf (VR,RAIN_CFMAS_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'PRIS_CFMAS_FAC')    CALL varsetf (VR,PRIS_CFMAS_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'SNOW_CFMAS_FAC')    CALL varsetf (VR,SNOW_CFMAS_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'AGG_CFMAS_FAC')    CALL varsetf (VR,AGG_CFMAS_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'GRAUP_CFMAS_FAC')    CALL varsetf (VR,GRAUP_CFMAS_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'HAIL_CFMAS_FAC')    CALL varsetf (VR,HAIL_CFMAS_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'DRIZ_CFMAS_FAC')    CALL varsetf (VR,DRIZ_CFMAS_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'CLOUD_PWMAS_FAC')    CALL varsetf (VR,CLOUD_PWMAS_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'RAIN_PWMAS_FAC')    CALL varsetf (VR,RAIN_PWMAS_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'PRIS_PWMAS_FAC')    CALL varsetf (VR,PRIS_PWMAS_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'SNOW_PWMAS_FAC')    CALL varsetf (VR,SNOW_PWMAS_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'AGG_PWMAS_FAC')    CALL varsetf (VR,AGG_PWMAS_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'GRAUP_PWMAS_FAC')    CALL varsetf (VR,GRAUP_PWMAS_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'HAIL_PWMAS_FAC')    CALL varsetf (VR,HAIL_PWMAS_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'DRIZ_PWMAS_FAC')    CALL varsetf (VR,DRIZ_PWMAS_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'CLOUD_CFVT_FAC')    CALL varsetf (VR,CLOUD_CFVT_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'RAIN_CFVT_FAC')    CALL varsetf (VR,RAIN_CFVT_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'PRIS_CFVT_FAC')    CALL varsetf (VR,PRIS_CFVT_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'SNOW_CFVT_FAC')    CALL varsetf (VR,SNOW_CFVT_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'AGG_CFVT_FAC')    CALL varsetf (VR,AGG_CFVT_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'GRAUP_CFVT_FAC')    CALL varsetf (VR,GRAUP_CFVT_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'HAIL_CFVT_FAC')    CALL varsetf (VR,HAIL_CFVT_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'DRIZ_CFVT_FAC')    CALL varsetf (VR,DRIZ_CFVT_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'CLOUD_PWVT_FAC')    CALL varsetf (VR,CLOUD_PWVT_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'RAIN_PWVT_FAC')    CALL varsetf (VR,RAIN_PWVT_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'PRIS_PWVT_FAC')    CALL varsetf (VR,PRIS_PWVT_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'SNOW_PWVT_FAC')    CALL varsetf (VR,SNOW_PWVT_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'AGG_PWVT_FAC')    CALL varsetf (VR,AGG_PWVT_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'GRAUP_PWVT_FAC')    CALL varsetf (VR,GRAUP_PWVT_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'HAIL_PWVT_FAC')    CALL varsetf (VR,HAIL_PWVT_FAC,NV,1,FF,0.,5.)
 IF(VR.EQ.'DRIZ_PWVT_FAC')    CALL varsetf (VR,DRIZ_PWVT_FAC,NV,1,FF,0.,5.)
...
WRITE(6,'(100(3(A15,E11.4)/))')      &
 ...
 ,'RIMEFACH=',RIMEFACH             &
 ,'SHEDFAC=',SHEDFAC                &
 ,'RAINMINEFF=',RAINMINEFF           &
 ,'CLOUD_CFMAS_FAC=',CLOUD_CFMAS_FAC	 &
 ,'RAIN_CFMAS_FAC=',RAIN_CFMAS_FAC 		&  
 ,'PRIS_CFMAS_FAC=',PRIS_CFMAS_FAC		&
 ,'SNOW_CFMAS_FAC=',SNOW_CFMAS_FAC		&  
 ,'AGG_CFMAS_FAC=',AGG_CFMAS_FAC		&  
 ,'GRAUP_CFMAS_FAC=',GRAUP_CFMAS_FAC	&  
 ,'HAIL_CFMAS_FAC=',HAIL_CFMAS_FAC		&  
 ,'DRIZ_CFMAS_FAC=',DRIZ_CFMAS_FAC		&
 ,'CLOUD_PWMAS_FAC=',CLOUD_PWMAS_FAC	&  
 ,'RAIN_PWMAS_FAC=',RAIN_PWMAS_FAC		&
 ,'PRIS_PWMAS_FAC=',PRIS_PWMAS_FAC		&  
 ,'SNOW_PWMAS_FAC=',SNOW_PWMAS_FAC		&  
 ,'AGG_PWMAS_FAC=',AGG_PWMAS_FAC		&  
 ,'GRAUP_PWMAS_FAC=',GRAUP_PWMAS_FAC	&  
 ,'HAIL_PWMAS_FAC=',HAIL_PWMAS_FAC		&
 ,'DRIZ_PWMAS_FAC=',DRIZ_PWMAS_FAC		&
 ,'CLOUD_CFVT_FAC=',CLOUD_CFVT_FAC	 &
 ,'RAIN_CFVT_FAC=',RAIN_CFVT_FAC 		&  
 ,'PRIS_CFVT_FAC=',PRIS_CFVT_FAC		&
 ,'SNOW_CFVT_FAC=',SNOW_CFVT_FAC		&  
 ,'AGG_CFVT_FAC=',AGG_CFVT_FAC		&  
 ,'GRAUP_CFVT_FAC=',GRAUP_CFVT_FAC	&  
 ,'HAIL_CFVT_FAC=',HAIL_CFVT_FAC		&  
 ,'DRIZ_CFVT_FAC=',DRIZ_CFVT_FAC		&
 ,'CLOUD_PWVT_FAC=',CLOUD_PWVT_FAC	&  
 ,'RAIN_PWVT_FAC=',RAIN_PWVT_FAC		&
 ,'PRIS_PWVT_FAC=',PRIS_PWVT_FAC		&  
 ,'SNOW_PWVT_FAC=',SNOW_PWVT_FAC		&  
 ,'AGG_PWVT_FAC=',AGG_PWVT_FAC		&  
 ,'GRAUP_PWVT_FAC=',GRAUP_PWVT_FAC	&  
 ,'HAIL_PWVT_FAC=',HAIL_PWVT_FAC		&
 ,'DRIZ_PWVT_FAC=',DRIZ_PWVT_FAC		&
 ,'CIN_MAX=',CIN_MAX                 &
 ,'CIN_SH=',CIN_SH                   &
 ,'CCN_SH=',CCN_SH                   &
 ,'BL_HGT=',BL_HGT                   &
