...
implicit none
  ...
  if (my_rams_num .eq. mainnum) then
    ...
    CALL par_put_float (CIN_SH,1)
    CALL par_put_int   (ICCN_PROF,1)
    CALL par_put_float (CCN_SH,1)
    CALL par_put_float (BL_HGT,1)
    CALL par_put_float (TRAN_DEPTH,1)
    CALL par_put_float (CCN_FT,1)
    ...
    CALL par_put_int   (IAGGFUNC4,1)
    CALL par_put_int   (IAGGFUNC5,1)
    CALL par_put_int   (IAGGFUNC6,1)
    ...
    CALL par_put_float (RIMEFACS,1)
    CALL par_put_float (RIMEFACA,1)
    CALL par_put_float (RIMEFACG,1)
    CALL par_put_float (RIMEFACH,1)
    CALL par_put_float (SHEDFAC,1)
    CALL par_put_float (RAINMINEFF,1)
    CALL par_put_float (CLOUD_CFMAS_FAC,1)
    CALL par_put_float (RAIN_CFMAS_FAC,1)
    CALL par_put_float (PRIS_CFMAS_FAC,1)
    CALL par_put_float (SNOW_CFMAS_FAC,1)
    CALL par_put_float (AGG_CFMAS_FAC,1)
    CALL par_put_float (GRAUP_CFMAS_FAC,1)
    CALL par_put_float (HAIL_CFMAS_FAC,1)
    CALL par_put_float (DRIZ_CFMAS_FAC,1)
    CALL par_put_float (CLOUD_PWMAS_FAC,1)
    CALL par_put_float (RAIN_PWMAS_FAC,1)
    CALL par_put_float (PRIS_PWMAS_FAC,1)
    CALL par_put_float (SNOW_PWMAS_FAC,1)
    CALL par_put_float (AGG_PWMAS_FAC,1)
    CALL par_put_float (GRAUP_PWMAS_FAC,1)
    CALL par_put_float (HAIL_PWMAS_FAC,1)
    CALL par_put_float (DRIZ_PWMAS_FAC,1)
    CALL par_put_float (CLOUD_CFVT_FAC,1)
    CALL par_put_float (RAIN_CFVT_FAC,1)
    CALL par_put_float (PRIS_CFVT_FAC,1)
    CALL par_put_float (SNOW_CFVT_FAC,1)
    CALL par_put_float (AGG_CFVT_FAC,1)
    CALL par_put_float (GRAUP_CFVT_FAC,1)
    CALL par_put_float (HAIL_CFVT_FAC,1)
    CALL par_put_float (DRIZ_CFVT_FAC,1)
    CALL par_put_float (CLOUD_PWVT_FAC,1)
    CALL par_put_float (RAIN_PWVT_FAC,1)
    CALL par_put_float (PRIS_PWVT_FAC,1)
    CALL par_put_float (SNOW_PWVT_FAC,1)
    CALL par_put_float (AGG_PWVT_FAC,1)
    CALL par_put_float (GRAUP_PWVT_FAC,1)
    CALL par_put_float (HAIL_PWVT_FAC,1)
    CALL par_put_float (DRIZ_PWVT_FAC,1)
    ...
    CALL par_get_float (CIN_SH,1)
    CALL par_get_int   (ICCN_PROF,1)
    CALL par_get_float (CCN_SH,1)
    CALL par_get_float (BL_HGT,1)
    CALL par_get_float (TRAN_DEPTH,1)
    CALL par_get_float (CCN_FT,1)
    ...
    CALL par_get_int   (IAGGFUNC4,1)
    CALL par_get_int   (IAGGFUNC5,1)
    CALL par_get_int   (IAGGFUNC6,1)
    ...
    CALL par_get_float (RIMEFACS,1)
    CALL par_get_float (RIMEFACA,1)
    CALL par_get_float (RIMEFACG,1)
    CALL par_get_float (RIMEFACH,1)
    CALL par_get_float (SHEDFAC,1)
    CALL par_get_float (RAINMINEFF,1)
    CALL par_get_float (CLOUD_CFMAS_FAC,1)
    CALL par_get_float (RAIN_CFMAS_FAC,1)
    CALL par_get_float (PRIS_CFMAS_FAC,1)
    CALL par_get_float (SNOW_CFMAS_FAC,1)
    CALL par_get_float (AGG_CFMAS_FAC,1)
    CALL par_get_float (GRAUP_CFMAS_FAC,1)
    CALL par_get_float (HAIL_CFMAS_FAC,1)
    CALL par_get_float (DRIZ_CFMAS_FAC,1)
    CALL par_get_float (CLOUD_PWMAS_FAC,1)
    CALL par_get_float (RAIN_PWMAS_FAC,1)
    CALL par_get_float (PRIS_PWMAS_FAC,1)
    CALL par_get_float (SNOW_PWMAS_FAC,1)
    CALL par_get_float (AGG_PWMAS_FAC,1)
    CALL par_get_float (GRAUP_PWMAS_FAC,1)
    CALL par_get_float (HAIL_PWMAS_FAC,1)
    CALL par_get_float (DRIZ_PWMAS_FAC,1)
    CALL par_get_float (CLOUD_CFVT_FAC,1)
    CALL par_get_float (RAIN_CFVT_FAC,1)
    CALL par_get_float (PRIS_CFVT_FAC,1)
    CALL par_get_float (SNOW_CFVT_FAC,1)
    CALL par_get_float (AGG_CFVT_FAC,1)
    CALL par_get_float (GRAUP_CFVT_FAC,1)
    CALL par_get_float (HAIL_CFVT_FAC,1)
    CALL par_get_float (DRIZ_CFVT_FAC,1)
    CALL par_get_float (CLOUD_PWVT_FAC,1)
    CALL par_get_float (RAIN_PWVT_FAC,1)
    CALL par_get_float (PRIS_PWVT_FAC,1)
    CALL par_get_float (SNOW_PWVT_FAC,1)
    CALL par_get_float (AGG_PWVT_FAC,1)
    CALL par_get_float (GRAUP_PWVT_FAC,1)
    CALL par_get_float (HAIL_PWVT_FAC,1)
    CALL par_get_float (DRIZ_PWVT_FAC,1)
